...
<header class="container">
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Макроэкономика</a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=c">Страны</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=v">События</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=n">Экспорт</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=b">Экономика</a>
                    </li>
                </ul>
